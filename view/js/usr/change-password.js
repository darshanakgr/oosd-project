...
function checkPWisMatch() {
    var iniPW = document.getElementById('cp-password');
    var rePW= document.getElementById('cp-repassword');
...
function doSetPassword() {
    var pwInput=document.getElementById('cp-password');
    var pwConfirm=document.getElementById('cp-repassword');
    var imgEye=document.getElementById('cp-dispEye');
