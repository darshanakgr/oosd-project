...
class ReceptionEditRegularSocket {
    constructor(io, socket) {
        console.log('Connection established on /reception-edit-regular');

        socket.on('disconnect', () => {
            console.log('Connection is interrupted on /reception-edit-regular');
        });
...
module.exports = {ReceptionEditRegularSocket};