...
class ReceptionCreateAdvertisementSocket {
    constructor(io, socket) {
        console.log('Connection established on /reception-create-advertisement');

        socket.on('disconnect', () => {
            console.log('Connection is interrupted on /reception-create-regular');
        });
...
module.exports = {ReceptionCreateAdvertisementSocket};
