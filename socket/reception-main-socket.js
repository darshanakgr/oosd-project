...
class ReceptionMainSocket {
    constructor(io, socket) {
        console.log('Connection established on /reception');

        socket.on('disconnect', () => {
            console.log('Connection is interrupted on /reception');
        });
...
module.exports = {ReceptionMainSocket};
