...
class LecturerEditEventSocket {
    constructor(io, socket) {
        console.log('Connection established on /lecturer-edit-event');

        socket.on('disconnect', () => {
            console.log('Connection is interrupted on /lectirer-create-regular');
        });
...
module.exports = {LecturerEditEventSocket};