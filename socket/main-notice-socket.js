...
class MainNoticeSocket {
    constructor(io, socket) {
        console.log('Connection established on /main-notices');

        socket.on('disconnect', () => {
            console.log('Connection is interrupted on /main-notices');
        });
...
module.exports = {MainNoticeSocket};
