...
class LecturerMainSocket {
    constructor(io, socket) {
        console.log('Connection established on /lecturer-main');

        socket.on('disconnect', () => {
            console.log('Connection is interrupted on /lecturer-main');
        });
...
module.exports = {LecturerMainSocket};
